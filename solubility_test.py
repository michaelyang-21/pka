...
final_model = lgb.train(params, data, num_boost_round=100)
...
print("Final Model - Mean Squared Error on Testing Set:", mse_test)
print("Final Model - Mean Absolute Error on Testing Set:", mae_test)
print("Final Model - R^2 on Testing Set:", r)
